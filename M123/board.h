...
//check the range for board id
#define MIN_BOARD_ID 1
#define MAX_BOARD_ID 2
...
private:
     ...
     * If the cell id a player cell then returns the player's direction string
    */
...
public:
    ...
    */
    ...
    /*
     * check if an board id is between MIN_BOARD_ID and MAX_BOARD_ID
     */
    static bool isValidBoardId(int id);
