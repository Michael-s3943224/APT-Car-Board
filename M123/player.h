...
//added this for invalid player direction
#define DIRECTION_ARROW_OUTPUT_ERROR "?" 

//the number of directions (I would put this in the Direction enum but I don't think I'm allowed to change it)
...
public:
	...
	/**
	 * Convert the direction of the player to a string of an arrow that represents that direction
	*/
	std::string directionToArrowString() const;
};
