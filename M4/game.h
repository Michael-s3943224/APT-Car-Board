...
private:
     ...
     */
    StatusResponse handleGenerateCommand(const std::vector<std::string>& params);
    ...
    /*
     * Check if a string is DIRECTION_NORTH, DIRECTION_EAST, DIRECTION_WEST or DIRECTION_SOUTH
     ...
     */
    static void showCmdInfoGenerate();
